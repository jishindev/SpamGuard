...
import com.jishin.android.spamguard.R
import com.jishin.android.spamguard.core.db.entities.Contact
import com.jishin.android.spamguard.databinding.BsAddBlockedNumberBinding
import com.jishin.android.spamguard.hasValidNumber
        ...
        with(binding) {
            ...
            fabConfirm.setOnClickListener {
                ...
                if (etNumber.hasValidNumber()) {
                    ...
                    /* Toast.makeText(
                         activity,
                         "Blocked ${etNumber.text.toString()}",
                         Toast.LENGTH_SHORT
                     ).show()*/
                } else
